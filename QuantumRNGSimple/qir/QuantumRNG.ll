...
entry:
  ...
  %1 = call %Array* @Microsoft__Quantum__Arrays___84ceb602d904434981d65a62f11ce9e6_Mapped__body(%Callable* %0, %Array* %input)
  call void @__quantum__rt__array_update_alias_count(%Array* %input, i32 -1)
...
define internal %Array* @Microsoft__Quantum__Arrays___84ceb602d904434981d65a62f11ce9e6_Mapped__body(%Callable* %mapper, %Array* %array) {
entry:
